...
shelltrap:{
anim:function(scene,_ref186){var attacker=_ref186[0],defenders=_ref186.slice(1);for(var _i8=0;_i8<
...
defenders.length;_i16++){var defender=defenders[_i16];for(var _i18=0,_ref218=
['mistball','heart'];_i18<_ref218.length;_i18++){var effect=_ref218[_i18];
for(var i=0;i<4;i++){
...
wildboltstorm:{
anim:function(scene,_ref219){var attacker=_ref219[0],defenders=_ref219.slice(1);
scene.backgroundEffect('#F6D434',1000,0.3);for(var _i20=0;_i20<

defenders.length;_i20++){var defender=defenders[_i20];for(var _i22=0,_ref221=
['blackwisp','lightning'];_i22<_ref221.length;_i22++){var effect=_ref221[_i22];
for(var i=0;i<4;i++){
scene.showEffect(effect,{
x:defender.x+50,
y:defender.y-35,
...
sandsearstorm:{
anim:function(scene,_ref222){var attacker=_ref222[0],defenders=_ref222.slice(1);
...
boomburst:{
anim:function(scene,_ref231){var attacker=_ref231[0],defenders=_ref231.slice(1);for(var _i26=0;_i26<
...
heatwave:{
anim:function(scene,_ref232){var attacker=_ref232[0],defenders=_ref232.slice(1);for(var _i28=0;_i28<
...
icywind:{
anim:function(scene,_ref259){var attacker=_ref259[0],defenders=_ref259.slice(1);for(var _i30=0;_i30<
...
sludgewave:{
anim:function(scene,_ref269){var attacker=_ref269[0],defenders=_ref269.slice(1);for(var _i32=0;_i32<
...
rockslide:{
anim:function(scene,_ref281){var attacker=_ref281[0],defenders=_ref281.slice(1);for(var _i34=0;_i34<
...
thousandarrows:{
anim:function(scene,_ref284){var attacker=_ref284[0],defenders=_ref284.slice(1);for(var _i36=0;_i36<
...
thousandwaves:{
anim:function(scene,_ref285){var attacker=_ref285[0],defenders=_ref285.slice(1);for(var _i38=0;_i38<
...
scene.backgroundEffect('#BB59FF',1000,0.4);for(var _i40=0,_ref295=

['x','y',''];_i40<_ref295.length;_i40++){var axis=_ref295[_i40];
scene.showEffect('shadowball',{
...
fierywrath:{
anim:function(scene,_ref297){var attacker=_ref297[0],defenders=_ref297.slice(1);for(var _i42=0;_i42<
...
mysticalpower:{
anim:function(scene,_ref319){var attacker=_ref319[0];
scene.showEffect('mistball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
surf:{
anim:function(scene,_ref339){var attacker=_ref339[0],defenders=_ref339.slice(1);for(var _i47=0;_i47<
...
muddywater:{
anim:function(scene,_ref341){var attacker=_ref341[0],defenders=_ref341.slice(1);for(var _i49=0;_i49<
...
lavaplume:{
anim:function(scene,_ref343){var attacker=_ref343[0],defenders=_ref343.slice(1);for(var _i51=0;_i51<
...
dragonenergy:{
anim:function(scene,_ref344){var attacker=_ref344[0],defenders=_ref344.slice(1);for(var _i53=0;_i53<
...
eruption:{
anim:function(scene,_ref345){var attacker=_ref345[0],defenders=_ref345.slice(1);for(var _i55=0;_i55<
...
waterspout:{
anim:function(scene,_ref346){var attacker=_ref346[0],defenders=_ref346.slice(1);for(var _i57=0;_i57<
...
prepareAnim:function(scene,_ref349){var attacker=_ref349[0];
scene.showEffect('electroball',{
x:attacker.x-60,
y:attacker.y+40,
z:attacker.z,
...
darkvoid:{
anim:function(scene,_ref374){var attacker=_ref374[0],defenders=_ref374.slice(1);for(var _i61=0;_i61<
