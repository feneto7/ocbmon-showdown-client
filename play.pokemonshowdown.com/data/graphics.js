...
Dex.getTypeIconUrl(type)+"\" alt=\""+type+"\" class=\"pixelated\" />";}
).join(' ');
...
status+='+<img src="'+Dex.getTypeIconUrl(_type)+'" alt="'+_type+'" class="pixelated" /> ';
}
...
metronome:{
anim:function(scene,_ref13){var attacker=_ref13[0];
scene.showEffect('pointer',{
x:attacker.x+30,
y:attacker.y+30,
z:attacker.z,
...
defenders.length;_i16++){var defender=defenders[_i16];for(var _i18=0,_ref219=
['mistball','heart'];_i18<_ref219.length;_i18++){var effect=_ref219[_i18];
for(var i=0;i<4;i++){
...
defenders.length;_i20++){var defender=defenders[_i20];for(var _i22=0,_ref222=
['blackwisp','lightning'];_i22<_ref222.length;_i22++){var effect=_ref222[_i22];
for(var i=0;i<4;i++){
scene.showEffect(effect,{
x:defender.x+50,
y:defender.y-35,
...
boomburst:{
anim:function(scene,_ref232){var attacker=_ref232[0],defenders=_ref232.slice(1);for(var _i26=0;_i26<
...
heatwave:{
anim:function(scene,_ref233){var attacker=_ref233[0],defenders=_ref233.slice(1);for(var _i28=0;_i28<
...
icywind:{
anim:function(scene,_ref260){var attacker=_ref260[0],defenders=_ref260.slice(1);for(var _i30=0;_i30<
...
sludgewave:{
anim:function(scene,_ref270){var attacker=_ref270[0],defenders=_ref270.slice(1);for(var _i32=0;_i32<
...
rockslide:{
anim:function(scene,_ref282){var attacker=_ref282[0],defenders=_ref282.slice(1);for(var _i34=0;_i34<
...
thousandarrows:{
anim:function(scene,_ref285){var attacker=_ref285[0],defenders=_ref285.slice(1);for(var _i36=0;_i36<
...
thousandwaves:{
anim:function(scene,_ref286){var attacker=_ref286[0],defenders=_ref286.slice(1);for(var _i38=0;_i38<
...
scene.backgroundEffect('#BB59FF',1000,0.4);for(var _i40=0,_ref296=

['x','y',''];_i40<_ref296.length;_i40++){var axis=_ref296[_i40];
scene.showEffect('shadowball',{
...
fierywrath:{
anim:function(scene,_ref298){var attacker=_ref298[0],defenders=_ref298.slice(1);for(var _i42=0;_i42<
...
wish:{
anim:function(scene,_ref310){var attacker=_ref310[0];
...
residualAnim:function(scene,_ref311){var attacker=_ref311[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
residualAnim:function(scene,_ref313){var attacker=_ref313[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y+130,
z:attacker.z,
...
surf:{
anim:function(scene,_ref340){var attacker=_ref340[0],defenders=_ref340.slice(1);for(var _i47=0;_i47<
...
muddywater:{
anim:function(scene,_ref342){var attacker=_ref342[0],defenders=_ref342.slice(1);for(var _i49=0;_i49<
...
lavaplume:{
anim:function(scene,_ref344){var attacker=_ref344[0],defenders=_ref344.slice(1);for(var _i51=0;_i51<
...
dragonenergy:{
anim:function(scene,_ref345){var attacker=_ref345[0],defenders=_ref345.slice(1);for(var _i53=0;_i53<
...
eruption:{
anim:function(scene,_ref346){var attacker=_ref346[0],defenders=_ref346.slice(1);for(var _i55=0;_i55<
...
waterspout:{
anim:function(scene,_ref347){var attacker=_ref347[0],defenders=_ref347.slice(1);for(var _i57=0;_i57<
...
prepareAnim:function(scene,_ref350){var attacker=_ref350[0];
scene.showEffect('electroball',{
x:attacker.x-60,
y:attacker.y+40,
z:attacker.z,
...
darkvoid:{
anim:function(scene,_ref375){var attacker=_ref375[0],defenders=_ref375.slice(1);for(var _i61=0;_i61<
