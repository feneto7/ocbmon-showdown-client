...
metronome:{
anim:function(scene,_ref1){var attacker=_ref1[0];
scene.showEffect('pointer',{
x:attacker.x+30,
y:attacker.y+30,
z:attacker.z,
...
shelltrap:{
anim:function(scene,_ref177){var attacker=_ref177[0],defenders=_ref177.slice(1);for(var _i6=0;_i6<
...
defenders.length;_i0++){var defender=defenders[_i0];
defender.delay(275);
defender.anim({
y:defender.y-10,
time:75
...
scene.backgroundEffect('#FF99FF',1000,0.3);for(var _i10=0;_i10<

defenders.length;_i10++){var defender=defenders[_i10];for(var _i12=0,_ref208=
['mistball','heart'];_i12<_ref208.length;_i12++){var effect=_ref208[_i12];
for(var i=0;i<4;i++){
...
scene.backgroundEffect('#F6D434',1000,0.3);for(var _i14=0;_i14<

defenders.length;_i14++){var defender=defenders[_i14];for(var _i16=0,_ref211=
['blackwisp','lightning'];_i16<_ref211.length;_i16++){var effect=_ref211[_i16];
for(var i=0;i<4;i++){
scene.showEffect(effect,{
x:defender.x+50,
y:defender.y-35,
...
scene.backgroundEffect('#B47F1F',1000,0.3);for(var _i18=0;_i18<
...
boomburst:{
anim:function(scene,_ref221){var attacker=_ref221[0],defenders=_ref221.slice(1);for(var _i20=0;_i20<
...
heatwave:{
anim:function(scene,_ref222){var attacker=_ref222[0],defenders=_ref222.slice(1);for(var _i22=0;_i22<
defenders.length;_i22++){var _defender2=defenders[_i22];
...
scene.backgroundEffect("url('"+Config.routes.clientProtocol+"://"+Config.routes.client+"/fx/weather-densefog.png')",800,1);
...
icywind:{
anim:function(scene,_ref250){var attacker=_ref250[0],defenders=_ref250.slice(1);for(var _i24=0;_i24<
...
sludgewave:{
anim:function(scene,_ref260){var attacker=_ref260[0],defenders=_ref260.slice(1);for(var _i26=0;_i26<
defenders.length;_i26++){var _defender3=defenders[_i26];
...
rockslide:{
anim:function(scene,_ref271){var attacker=_ref271[0],defenders=_ref271.slice(1);for(var _i28=0;_i28<
...
thousandarrows:{
anim:function(scene,_ref274){var attacker=_ref274[0],defenders=_ref274.slice(1);for(var _i30=0;_i30<
defenders.length;_i30++){var _defender4=defenders[_i30];
...
defenders.length;_i32++){var _defender5=defenders[_i32];
...
scene.backgroundEffect('#BB59FF',1000,0.4);for(var _i34=0,_ref285=

['x','y',''];_i34<_ref285.length;_i34++){var axis=_ref285[_i34];
scene.showEffect('shadowball',{
...
fierywrath:{
anim:function(scene,_ref287){var attacker=_ref287[0],defenders=_ref287.slice(1);for(var _i36=0;_i36<
...
makeitrain:{
anim:function(scene,_ref323){var attacker=_ref323[0],defenders=_ref323.slice(1);for(var _i38=0;_i38<
...
surf:{
anim:function(scene,_ref330){var attacker=_ref330[0],defenders=_ref330.slice(1);for(var _i40=0;_i40<
defenders.length;_i40++){var _defender6=defenders[_i40];
...
muddywater:{
anim:function(scene,_ref332){var attacker=_ref332[0],defenders=_ref332.slice(1);for(var _i42=0;_i42<
defenders.length;_i42++){var _defender7=defenders[_i42];
...
eruption:{
anim:function(scene,_ref336){var attacker=_ref336[0],defenders=_ref336.slice(1);for(var _i48=0;_i48<
defenders.length;_i48++){var _defender8=defenders[_i48];
...
waterspout:{
anim:function(scene,_ref337){var attacker=_ref337[0],defenders=_ref337.slice(1);for(var _i50=0;_i50<
defenders.length;_i50++){var _defender9=defenders[_i50];
...
scene.backgroundEffect("url('"+Config.routes.clientProtocol+"://"+Config.routes.client+"/sprites/gen6bgs/bg-icecave.jpg')",1000,0.6);for(var _i52=0;_i52<
defenders.length;_i52++){var defender=defenders[_i52];
scene.showEffect('icicle',{
x:defender.x,
y:defender.y,
z:defender.z,
...
darkvoid:{
anim:function(scene,_ref363){var attacker=_ref363[0],defenders=_ref363.slice(1);for(var _i54=0;_i54<
defenders.length;_i54++){var _defender0=defenders[_i54];
_defender0.anim({
y:_defender0.y-80,
opacity:0,
time:300
...
scene.backgroundEffect('#FF99FF',700,0.3);for(var _i56=0;_i56<

defenders.length;_i56++){var _defender1=defenders[_i56];
_defender1.delay(350);
_defender1.anim({
z:_defender1.behind(5),
time:75
},'swing');
_defender1.anim({
time:75
...
scene.backgroundEffect('#000000',1300,0.3);for(var _i58=0;_i58<

defenders.length;_i58++){var _defender10=defenders[_i58];
_defender10.delay(700);
_defender10.anim({
z:_defender10.behind(10),
time:100
},'swing');
_defender10.anim({
time:200
...
z:attacker.z,
time:250
},'decel');for(var _i60=0;_i60<
defenders.length;_i60++){var defender=defenders[_i60];
var xstep=(defender.x-attacker.x)/5;
var ystep=(defender.x-200-attacker.x)/5;
var zstep=(defender.z-attacker.z)/5;
for(var i=0;i<5;i++){
...
scene.backgroundEffect('linear-gradient(#46AF71 20%, #1170F0)',1600,0.4,300);for(var _i62=0;_i62<

defenders.length;_i62++){var _defender11=defenders[_i62];
_defender11.delay(2075);
_defender11.anim({
x:_defender11.x-30,
time:75
});
...
scene.showEffect('wisp',{
x:attacker.leftof(-50)+xstep*(_i63+1),
y:attacker.y+275+ystep*(_i63+1),
z:attacker.behind(-150)+zstep*(_i63+1),
scale:1.3,
opacity:1,
time:5*_i63+900
},{
x:defender.leftof(-50)+xstep*(_i63+1),
...
scene.showEffect('wisp',{
x:attacker.leftof(50)+xstep*(_i64+1),
y:attacker.y+275+ystep*(_i64+1),
z:attacker.z+zstep*(_i64+1),
scale:1.3,
opacity:1,
time:5*_i64+1100
},{
x:defender.leftof(50)+xstep*(_i64+1),
opacity:0,
time:100*_i64+1200
},'linear');
}
...
scene.showEffect('poisonwisp',{
x:defender.x-150+xstep*(_i65+1),
y:defender.y+200+ystep*(_i65+1),
z:defender.z+zstep*(_i65+1),
scale:0.6,
opacity:0.7,
time:40*_i65+100
},{
...
scene.showEffect('poisonwisp',{
x:defender.x-100+xstep*(_i66+1),
y:defender.y+200+ystep*(_i66+1),
z:defender.z+zstep*(_i66+1),
scale:1.2,
opacity:1,
time:40*_i66+200
},{
...
scene.showEffect('electroball',{
x:attacker.x-150+xstep*(_i72+1),
y:attacker.y+200+ystep*(_i72+1),
z:attacker.z+zstep*(_i72+1),
scale:0.6,
opacity:0.7,
time:40*_i72+100
},{
...
scene.showEffect('waterwisp',{
x:attacker.x-100+xstep*(_i73+1),
y:attacker.y+200+ystep*(_i73+1),
z:attacker.z+zstep*(_i73+1),
scale:1.2,
opacity:1,
time:40*_i73+200
},{
...
defenders.length;_i80++){var _defender12=defenders[_i80];
_defender12.delay(1825);
_defender12.anim({
...
_defender12.anim({
z:_defender12.behind(15),
time:75,
opacity:0
},'swing');
_defender12.delay(400);
_defender12.anim({
time:200
},'swing');
}
...
greatrage:{
anim:function(scene,_ref448){var attacker=_ref448[0],defenders=_ref448.slice(1);for(var _i82=0;_i82<
defenders.length;_i82++){var defender=defenders[_i82];
defender.delay(125);
defender.anim({
z:defender.behind(5),
time:75
...
moregun:{
anim:function(scene,_ref449){var attacker=_ref449[0],defenders=_ref449.slice(1);for(var _i84=0;_i84<
defenders.length;_i84++){var _defender13=defenders[_i84];
_defender13.delay(425);
_defender13.anim({
x:_defender13.x-5,
time:75
},'swing');
...
thunderousdrumming:{
anim:function(scene,_ref454){var attacker=_ref454[0],defenders=_ref454.slice(1);for(var _i86=0;_i86<
...
coomdoom:{
anim:function(scene,_ref457){var attacker=_ref457[0],defenders=_ref457.slice(1);for(var _i88=0;_i88<
defenders.length;_i88++){var _defender14=defenders[_i88];
_defender14.delay(625);
_defender14.anim({
x:_defender14.x-30,
time:75
});
...
xstep=(defender.x+150-defender.x)/5;
for(var _i89=0;_i89<5;_i89++){
scene.showEffect('poisonwisp',{
x:defender.x-150+xstep*(_i89+1),
y:defender.y+200+ystep*(_i89+1),
z:defender.z+zstep*(_i89+1),
scale:0.6,
opacity:0.2,
time:40*_i89+300
},{
...
xstep=(defender.x+100-defender.x)/5;
for(var _i90=0;_i90<5;_i90++){
scene.showEffect('poisonwisp',{
x:defender.x-100+xstep*(_i90+1),
y:defender.y+200+ystep*(_i90+1),
z:defender.z+zstep*(_i90+1),
scale:1.2,
opacity:0.5,
time:40*_i90+400
},{
...
xstep=(defender.x+50-defender.x)/5;
for(var _i91=0;_i91<5;_i91++){
scene.showEffect('poisonwisp',{
x:defender.x-50+xstep*(_i91+1),
y:defender.y+200+ystep*(_i91+1),
z:defender.z+zstep*(_i91+1),
scale:0.6,
opacity:0.5,
time:40*_i91+500
},{
...
xstep=(defender.x-50-defender.x)/5;
for(var _i92=0;_i92<5;_i92++){
scene.showEffect('poisonwisp',{
x:defender.x+50+xstep*(_i92+1),
y:defender.y+200+ystep*(_i92+1),
z:defender.z+zstep*(_i92+1),
scale:1.2,
opacity:0.5,
time:40*_i92+600
},{
...
xstep=(defender.x-100-defender.x)/5;
for(var _i93=0;_i93<5;_i93++){
scene.showEffect('poisonwisp',{
x:defender.x+100+xstep*(_i93+1),
y:defender.y+200+ystep*(_i93+1),
z:defender.z+zstep*(_i93+1),
scale:0.6,
opacity:0.5,
time:40*_i93+700
},{
...
xstep=(defender.x-150-defender.x)/5;
for(var _i94=0;_i94<5;_i94++){
scene.showEffect('poisonwisp',{
x:defender.x+150+xstep*(_i94+1),
y:defender.y+200+ystep*(_i94+1),
z:defender.z+zstep*(_i94+1),
scale:0.6,
opacity:0.7,
time:40*_i94+800
},{
...
xstep=(defender.x-200-defender.x)/5;
for(var _i95=0;_i95<5;_i95++){
scene.showEffect('poisonwisp',{
x:defender.x+200+xstep*(_i95+1),
y:defender.y+200+ystep*(_i95+1),
z:defender.z+zstep*(_i95+1),
scale:0.6,
opacity:0.7,
time:40*_i95+900
},{
...
cloudbreaker:{
anim:function(scene,_ref472){var attacker=_ref472[0],defenders=_ref472.slice(1);for(var _i97=0;_i97<
defenders.length;_i97++){var _defender15=defenders[_i97];
_defender15.delay(280);
_defender15.anim({
z:_defender15.behind(20),
time:100
},'swing');
_defender15.anim({
time:300
...
firebomb:{
anim:function(scene,_ref483){var attacker=_ref483[0],defenders=_ref483.slice(1);for(var _i99=0;_i99<
defenders.length;_i99++){var defender=defenders[_i99];
defender.delay(200);
defender.anim({
y:defender.y-7,
yscale:0.9,
...
scene.backgroundEffect('#082179',1600,0.5,300);
scene.backgroundEffect('linear-gradient(#000000 20%, #2630A9)',1600,0.4,300);for(var _i101=0;_i101<

defenders.length;_i101++){var _defender16=defenders[_i101];
...
scene.showEffect('poisonwisp',{
x:attacker.leftof(-50)+xstep*(_i102+1),
y:attacker.y+275+ystep*(_i102+1),
z:attacker.behind(-150)+zstep*(_i102+1),
scale:1.3,
opacity:1,
time:5*_i102+900
},{
x:defender.leftof(-50)+xstep*(_i102+1),
z:attacker.z+zstep*(_i102+1),
opacity:0,
time:100*_i102+1000
},'linear');
}
...
for(var _i103=0;_i103<6;_i103++){
scene.showEffect('poisonwisp',{
x:attacker.leftof(50)+xstep*(_i103+1),
y:attacker.y+275+ystep*(_i103+1),
z:attacker.z+zstep*(_i103+1),
scale:1.3,
opacity:1,
time:5*_i103+1100
},{
x:defender.leftof(50)+xstep*(_i103+1),
opacity:0,
time:100*_i103+1200
},'linear');
}
...
leafshield:{
anim:function(scene,_ref506){var attacker=_ref506[0];
var xf=[1,-1,1,-1];
var yf=[1,-1,-1,1];
var xf2=[1,0,-1,0];
var yf2=[0,1,0,-1];
...
xstep=(defender.x+150-defender.x)/5;
for(var _i104=0;_i104<5;_i104++){
scene.showEffect('blackwisp',{
x:defender.x-150+xstep*(_i104+1),
y:defender.y+200+ystep*(_i104+1),
z:defender.z+zstep*(_i104+1),
scale:0.6,
opacity:0.7,
time:40*_i104+100
},{
...
xstep=(defender.x+100-defender.x)/5;
for(var _i105=0;_i105<5;_i105++){
scene.showEffect('blackwisp',{
x:defender.x-100+xstep*(_i105+1),
y:defender.y+200+ystep*(_i105+1),
z:defender.z+zstep*(_i105+1),
scale:1.2,
opacity:1,
time:40*_i105+200
},{
...
xstep=(defender.x+50-defender.x)/5;
for(var _i106=0;_i106<5;_i106++){
scene.showEffect('blackwisp',{
x:defender.x-50+xstep*(_i106+1),
y:defender.y+200+ystep*(_i106+1),
z:defender.z+zstep*(_i106+1),
scale:0.6,
opacity:0.7,
time:40*_i106+300
},{
...
xstep=(defender.x-50-defender.x)/5;
for(var _i107=0;_i107<5;_i107++){
scene.showEffect('blackwisp',{
x:defender.x+50+xstep*(_i107+1),
y:defender.y+200+ystep*(_i107+1),
z:defender.z+zstep*(_i107+1),
scale:1.2,
opacity:1,
time:40*_i107+400
},{
...
xstep=(defender.x-100-defender.x)/5;
for(var _i108=0;_i108<5;_i108++){
scene.showEffect('blackwisp',{
x:defender.x+100+xstep*(_i108+1),
y:defender.y+200+ystep*(_i108+1),
z:defender.z+zstep*(_i108+1),
scale:0.6,
opacity:0.7,
time:40*_i108+500
},{
...
xstep=(defender.x-150-defender.x)/5;
for(var _i109=0;_i109<5;_i109++){
scene.showEffect('blackwisp',{
x:defender.x+150+xstep*(_i109+1),
y:defender.y+200+ystep*(_i109+1),
z:defender.z+zstep*(_i109+1),
scale:0.6,
opacity:0.7,
time:40*_i109+600
},{
...
xstep=(defender.x-200-defender.x)/5;
for(var _i110=0;_i110<5;_i110++){
scene.showEffect('blackwisp',{
x:defender.x+200+xstep*(_i110+1),
y:defender.y+200+ystep*(_i110+1),
z:defender.z+zstep*(_i110+1),
scale:0.6,
opacity:0.7,
time:40*_i110+700
},{
...
opacity:0.8,
time:1000
},'linear','fade');for(var _i112=0;_i112<

defenders.length;_i112++){var defender=defenders[_i112];
scene.showEffect('heart',{
x:defender.x-25,
y:defender.y,
z:defender.behind(5),
...
charmerssong:{
anim:function(scene,_ref525){var attacker=_ref525[0],defenders=_ref525.slice(1);for(var _i114=0;_i114<
defenders.length;_i114++){var defender=defenders[_i114];
defender.delay(125);
defender.anim({
z:defender.behind(5),
time:75
...
maximize:{
anim:function(scene,_ref531){var attacker=_ref531[0];
scene.showEffect(attacker.sp,{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
heavensblessing:{
anim:function(scene,_ref534){var attacker=_ref534[0];
...
residualAnim:function(scene,_ref535){var attacker=_ref535[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/weather-strongwind.png')",600,0.4);
...
extinctionwave:{
anim:function(scene,_ref543){var attacker=_ref543[0],defenders=_ref543.slice(1);for(var _i116=0;_i116<
defenders.length;_i116++){var _defender17=defenders[_i116];
...
firewall:{
anim:function(scene,_ref548){var attacker=_ref548[0];
...
y:attacker.y,
time:100
});for(var _i118=0;_i118<

defenders.length;_i118++){var defender=defenders[_i118];
defender.anim({
y:defender.y-10,
time:75
});
...
pobybbolb:{
anim:function(scene,_ref554){var attacker=_ref554[0];
scene.showEffect('bloodwisp',{
x:attacker.x-20,
y:attacker.y-20,
z:attacker.z,
...
plushrush:{
anim:function(scene,_ref560){var attacker=_ref560[0],defender=_ref560[1];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y-30,
z:attacker.z,
...
dousingflame:{
anim:function(scene,_ref561){var attacker=_ref561[0],defender=_ref561[1];
...
laserbeam:{
anim:function(scene,_ref562){var attacker=_ref562[0],defender=_ref562[1];
...
coldfront:{
anim:function(scene,_ref563){var attacker=_ref563[0],defender=_ref563[1];
scene.backgroundEffect("url('"+Config.routes.clientProtocol+"://"+Config.routes.client+"/sprites/gen6bgs/bg-icecave.jpg')",1000,0.6);
scene.showEffect('icicle',{
x:attacker.x,
y:attacker.y,
...
icestorm:{
anim:function(scene,_ref564){var attacker=_ref564[0],defender=_ref564[1];
scene.backgroundEffect("url('"+Config.routes.clientProtocol+"://"+Config.routes.client+"/sprites/gen6bgs/bg-icecave.jpg')",1000,0.6);
scene.showEffect('icicle',{
x:attacker.x,
y:attacker.y,
...
cursedblade:{
anim:function(scene,_ref565){var attacker=_ref565[0],defender=_ref565[1];
scene.backgroundEffect('#000000',650,0.5);
scene.showEffect('shadowball',{
x:defender.x+30,
y:defender.y+25,
...
"this":{
anim:function(scene,_ref566){var attacker=_ref566[0],defender=_ref566[1];
...
acridblaze:{
anim:function(scene,_ref567){var attacker=_ref567[0],defender=_ref567[1];
scene.backgroundEffect('#FF0000',700,0.5);
scene.showEffect('flareball',{
x:attacker.x,
y:attacker.y,
...
shellup:{
anim:function(scene,_ref568){var attacker=_ref568[0];
scene.showEffect('shell',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
bloodshot:{
anim:function(scene,_ref569){var attacker=_ref569[0],defender=_ref569[1];
scene.backgroundEffect('#FF99FF',700,0.3);
scene.showEffect('bloodwisp',{
x:attacker.x,
y:attacker.y,
...
shadowbox:{
anim:function(scene,_ref570){var attacker=_ref570[0],defender=_ref570[1];
attacker.anim({
x:defender.leftof(-30),
y:defender.y+80,
z:defender.behind(-30),
...
energyburst:{
anim:function(scene,_ref571){var attacker=_ref571[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
bishido:{
anim:function(scene,_ref572){var attacker=_ref572[0],defender=_ref572[1];
scene.showEffect('rightslash',{
x:attacker.x,
y:attacker.y,
z:attacker.behind(-30),
...
requiemrend:{
anim:function(scene,_ref573){var attacker=_ref573[0],defender=_ref573[1];
var xstep=(defender.x-attacker.x)/5;
var ystep=(defender.y-attacker.y)/5;
var zstep=(defender.z-attacker.z)/5;
...
mourninglament:{
anim:function(scene,_ref574){var attacker=_ref574[0],defender=_ref574[1];
var xstep=(defender.x-attacker.x)/5;
var ystep=(defender.y-attacker.y)/5;
var zstep=(defender.z-attacker.z)/5;
scene.backgroundEffect('#000000',100,0.9,200);
scene.backgroundEffect('#ffffff',200,0.9,300);
scene.backgroundEffect('#000000',100,0.9,500);
scene.backgroundEffect('#ffffff',200,0.9,600);
scene.backgroundEffect('#000000',100,0.9,800);
scene.backgroundEffect('#ffffff',200,0.9,900);
for(var i=0;i<5;i++){
scene.showEffect('flareball',{
x:attacker.x+xstep*(i+1),
y:attacker.y+ystep*(i+1),
...
funnyfun:{
anim:function(scene,_ref575){var attacker=_ref575[0],defender=_ref575[1];
scene.showEffect('heart',{
x:attacker.x-10,
y:attacker.y+50,
z:attacker.z,
...
trapcard:{
anim:function(scene,_ref576){var attacker=_ref576[0],defender=_ref576[1];
...
wickedblow:{
anim:function(scene,_ref577){var attacker=_ref577[0],defender=_ref577[1];
scene.backgroundEffect('#000000',900,0.3);
BattleOtherAnims.fastattack.anim(scene,[attacker,defender]);
scene.showEffect('fist',{
x:defender.x,
...
nuclearwinter:{
anim:function(scene,_ref578){var attacker=_ref578[0],defenders=_ref578.slice(1);
scene.backgroundEffect("url('"+Config.routes.clientProtocol+"://"+Config.routes.client+"/sprites/gen6bgs/bg-icecave.jpg')",1000,0.6);for(var _i120=0;_i120<
defenders.length;_i120++){var defender=defenders[_i120];
...
cbt:{
anim:function(scene,_ref579){var attacker=_ref579[0],defender=_ref579[1];
attacker.anim({
x:defender.leftof(-30),
y:defender.y+80,
z:defender.behind(-30),
...
transrights:{
anim:function(scene,_ref580){var attacker=_ref580[0];
...
unabletograsp:{
anim:function(scene,_ref581){var attacker=_ref581[0],defenders=_ref581.slice(1);for(var _i122=0;_i122<
defenders.length;_i122++){var defender=defenders[_i122];
defender.delay(125);
defender.anim({
z:defender.behind(5),
time:75
...
anim:function(scene,_ref582){var attacker=_ref582[0],defender=_ref582[1];
...
BattleMoveAnims['boil']={anim:BattleMoveAnims['scald'].anim};
...
anim:function(scene,_ref583){var attacker=_ref583[0],defender=_ref583[1];
...
anim:function(scene,_ref584){var attacker=_ref584[0],defender=_ref584[1];
...
anim:function(scene,_ref585){var attacker=_ref585[0],defender=_ref585[1];
...
BattleMoveAnims['boilover']={anim:BattleMoveAnims['dousingflame'].anim};
BattleMoveAnims['borebite']={anim:BattleMoveAnims['poisonfang'].anim};
...
anim:function(scene,_ref586){var attacker=_ref586[0],defender=_ref586[1];
...
anim:function(scene,_ref587){var attacker=_ref587[0],defender=_ref587[1];
BattleMoveAnims['focuspunch'].anim(scene,[attacker,defender]);
BattleMoveAnims['earthpower'].anim(scene,[attacker,defender]);
}
};
BattleMoveAnims['carvingbeak']={
anim:function(scene,_ref588){var attacker=_ref588[0],defender=_ref588[1];
...
anim:function(scene,_ref589){var attacker=_ref589[0],defender=_ref589[1];
...
anim:function(scene,_ref590){var attacker=_ref590[0],defender=_ref590[1];
...
anim:function(scene,_ref591){var attacker=_ref591[0],defender=_ref591[1];
...
anim:function(scene,_ref592){var attacker=_ref592[0],defender=_ref592[1];
...
anim:function(scene,_ref593){var attacker=_ref593[0],defender=_ref593[1];
...
anim:function(scene,_ref594){var attacker=_ref594[0],defender=_ref594[1];
BattleMoveAnims['followme'].anim(scene,[attacker,defender]);
}
};
BattleMoveAnims['abyssalwave']={
anim:function(scene,_ref595){var attacker=_ref595[0],defender=_ref595[1];
...
anim:function(scene,_ref596){var attacker=_ref596[0],defender=_ref596[1];
...
anim:function(scene,_ref597){var attacker=_ref597[0],defender=_ref597[1];
BattleMoveAnims['rollout'].anim(scene,[attacker,defender]);
BattleMoveAnims['headsmash'].anim(scene,[attacker,defender]);
}
};
BattleMoveAnims['psiblobbin']={
anim:function(scene,_ref598){var attacker=_ref598[0],defender=_ref598[1];
...
anim:function(scene,_ref599){var attacker=_ref599[0],defender=_ref599[1];
...
anim:function(scene,_ref600){var attacker=_ref600[0],defender=_ref600[1];
...
anim:function(scene,_ref601){var attacker=_ref601[0],defender=_ref601[1];
BattleMoveAnims['geomancy'].anim(scene,[attacker,defender]);
BattleMoveAnims['milkdrink'].anim(scene,[attacker,defender]);
}
};
BattleMoveAnims['deepfry']={
anim:function(scene,_ref602){var attacker=_ref602[0],defender=_ref602[1];
...
anim:function(scene,_ref603){var attacker=_ref603[0],defender=_ref603[1];
...
anim:function(scene,_ref604){var attacker=_ref604[0],defender=_ref604[1];
...
anim:function(scene,_ref605){var attacker=_ref605[0],defender=_ref605[1];
...
anim:function(scene,_ref606){var attacker=_ref606[0],defender=_ref606[1];
BattleMoveAnims['lusterpurge'].anim(scene,[attacker,defender]);
...
anim:function(scene,_ref607){var attacker=_ref607[0],defender=_ref607[1];
...
anim:function(scene,_ref608){var attacker=_ref608[0],defender=_ref608[1];
...
anim:function(scene,_ref609){var attacker=_ref609[0],defender=_ref609[1];
BattleMoveAnims['gunkshot'].anim(scene,[attacker,defender]);
BattleMoveAnims['hypervoice'].anim(scene,[attacker,defender]);
}
};
BattleMoveAnims['thunderblitz']={
anim:function(scene,_ref610){var attacker=_ref610[0],defender=_ref610[1];
...
anim:function(scene,_ref611){var attacker=_ref611[0],defender=_ref611[1];
BattleMoveAnims['crashhopper'].anim(scene,[attacker,defender]);
}
};
BattleMoveAnims['crystalslash']={
anim:function(scene,_ref612){var attacker=_ref612[0],defender=_ref612[1];
BattleMoveAnims['rockpolish'].anim(scene,[attacker,defender]);
BattleMoveAnims['slash'].anim(scene,[attacker,defender]);
}
};
BattleMoveAnims['berserkersoul']={
anim:function(scene,_ref613){var attacker=_ref613[0],defender=_ref613[1];
...
anim:function(scene,_ref614){var attacker=_ref614[0],defender=_ref614[1];
...
anim:function(scene,_ref615){var attacker=_ref615[0],defender=_ref615[1];
...
anim:function(scene,_ref616){var attacker=_ref616[0],defender=_ref616[1];
...
anim:function(scene,_ref617){var attacker=_ref617[0],defender=_ref617[1];
BattleMoveAnims['bulkup'].anim(scene,[attacker,defender]);
BattleMoveAnims['protect'].anim(scene,[attacker,defender]);
}
};
BattleMoveAnims['edgequake']={
anim:function(scene,_ref618){var attacker=_ref618[0],defender=_ref618[1];
BattleMoveAnims['stoneedge'].anim(scene,[attacker,defender]);
BattleMoveAnims['earthquake'].anim(scene,[attacker,defender]);
}
};
BattleMoveAnims['anyattack']={
anim:function(scene,_ref619){var attacker=_ref619[0],defender=_ref619[1];
BattleMoveAnims['nastyplot'].anim(scene,[attacker,defender]);
BattleMoveAnims['outrage'].anim(scene,[attacker,defender]);
}
};
BattleMoveAnims['anyheal']={
anim:function(scene,_ref620){var attacker=_ref620[0],defender=_ref620[1];
BattleMoveAnims['nastyplot'].anim(scene,[attacker,defender]);
BattleMoveAnims['recover'].anim(scene,[attacker,defender]);
}
};
BattleMoveAnims['anystatup']={
anim:function(scene,_ref621){var attacker=_ref621[0],defender=_ref621[1];
BattleMoveAnims['nastyplot'].anim(scene,[attacker,defender]);
BattleMoveAnims['geomancy'].anim(scene,[attacker,defender]);
}
};
BattleMoveAnims['anystatus']={
anim:function(scene,_ref622){var attacker=_ref622[0],defender=_ref622[1];
BattleMoveAnims['nastyplot'].anim(scene,[attacker,defender]);
...
anim:function(scene,_ref623){var attacker=_ref623[0],defender=_ref623[1];
...
anim:function(scene,_ref624){var attacker=_ref624[0],defender=_ref624[1];
BattleMoveAnims['aircutter'].anim(scene,[attacker,defender]);
BattleMoveAnims['fractus'].anim(scene,[attacker,defender]);
...
anim:function(scene,_ref625){var attacker=_ref625[0],defender=_ref625[1];
...
anim:function(scene,_ref626){var attacker=_ref626[0],defender=_ref626[1];
...
anim:function(scene,_ref627){var attacker=_ref627[0],defender=_ref627[1];
BattleMoveAnims['discharge'].anim(scene,[attacker,defender]);
BattleMoveAnims['boomburst'].anim(scene,[attacker,defender]);
BattleMoveAnims['nastyplot'].anim(scene,[attacker,defender]);
BattleMoveAnims['thunder'].anim(scene,[attacker,defender]);
...
anim:function(scene,_ref628){var attacker=_ref628[0],defender=_ref628[1];
...
anim:function(scene,_ref629){var attacker=_ref629[0],defender=_ref629[1];
...
anim:function(scene,_ref630){var attacker=_ref630[0],defender=_ref630[1];
BattleMoveAnims['sheercold'].anim(scene,[attacker,defender]);
...
anim:function(scene,_ref631){var attacker=_ref631[0],defender=_ref631[1];
...
anim:function(scene,_ref632){var attacker=_ref632[0],defender=_ref632[1];
BattleMoveAnims['firstimpression'].anim(scene,[attacker,defender]);
BattleMoveAnims['inferno'].anim(scene,[attacker,defender]);
}
};
BattleMoveAnims['snappingfrost']={
anim:function(scene,_ref633){var attacker=_ref633[0],defender=_ref633[1];
...
anim:function(scene,_ref634){var attacker=_ref634[0],defender=_ref634[1];
BattleMoveAnims['bulkup'].anim(scene,[attacker,defender]);
...
anim:function(scene,_ref635){var attacker=_ref635[0],defender=_ref635[1];
...
anim:function(scene,_ref636){var attacker=_ref636[0],defender=_ref636[1];
BattleMoveAnims['this'].anim(scene,[attacker,defender]);
...
anim:function(scene,_ref637){var attacker=_ref637[0],defender=_ref637[1];
BattleMoveAnims['spinout'].anim(scene,[attacker,defender]);
BattleMoveAnims['charge'].anim(scene,[attacker,defender]);
}
};
BattleMoveAnims['gotobed']={
anim:function(scene,_ref638){var attacker=_ref638[0],defender=_ref638[1];
...
anim:function(scene,_ref639){var attacker=_ref639[0],defender=_ref639[1];
...
anim:function(scene,_ref640){var attacker=_ref640[0],defender=_ref640[1];
BattleMoveAnims['solarbeam'].anim(scene,[attacker,defender]);
BattleMoveAnims['uproot'].anim(scene,[attacker,defender]);
}
};
BattleMoveAnims['itsbleak']={
anim:function(scene,_ref641){var attacker=_ref641[0],defender=_ref641[1];
...
anim:function(scene,_ref642){var attacker=_ref642[0],defender=_ref642[1];
BattleMoveAnims['flash'].anim(scene,[attacker,defender]);
BattleMoveAnims['inferno'].anim(scene,[attacker,defender]);
}
};
...
anim:function(scene,_ref643){var attacker=_ref643[0],defender=_ref643[1];
BattleMoveAnims['heatwave'].anim(scene,[attacker,defender]);
BattleMoveAnims['inferno'].anim(scene,[attacker,defender]);
...
anim:function(scene,_ref644){var attacker=_ref644[0],defender=_ref644[1];
...
anim:function(scene,_ref645){var attacker=_ref645[0],defender=_ref645[1];
...
anim:function(scene,_ref646){var attacker=_ref646[0],defender=_ref646[1];
...
anim:function(scene,_ref647){var attacker=_ref647[0],defender=_ref647[1];
BattleMoveAnims['faketears'].anim(scene,[attacker,defender]);
BattleMoveAnims['extinctionwave'].anim(scene,[attacker,defender]);
}
};
BattleMoveAnims['whirlingrods']={
anim:function(scene,_ref648){var attacker=_ref648[0],defender=_ref648[1];
BattleMoveAnims['wingsofcorrection'].anim(scene,[attacker,defender]);
...
anim:function(scene,_ref649){var attacker=_ref649[0],defender=_ref649[1];
...
anim:function(scene,_ref650){var attacker=_ref650[0],defender=_ref650[1];
BattleMoveAnims['voltaiccyclone'].anim(scene,[attacker,defender]);
BattleMoveAnims['extinctionwave'].anim(scene,[attacker,defender]);
...
anim:function(scene,_ref651){var attacker=_ref651[0],defender=_ref651[1];
