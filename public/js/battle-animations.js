...
var defaultTrack={file:'audio/viol.mp3',start:61783,end:95529};
...
updateGen=function updateGen(){var _this3=this,_this$battle$nearSide;
var forceGen3=['cloveronly','clovercaponly','cloverblobboscaponly','sburbmonsonly','sweetonly','clovertestonly','copeonly','copecapcabdraftonly'];
var gen=this.battle.gen;
if(Dex.prefs('nopastgens'))gen=6;
if(Dex.prefs('bwgfx')&&gen>5)gen=5;
if(forceGen3.some(function(force){return _this3.battle.id.includes(force);}))gen=3;
this.gen=gen;
...
var badgeBuffer='<span class="userbadges">';
side.badges.forEach(function(badge){
...
var badgeName=badge.badge_name;
...
updateStatbars=function updateStatbars(){for(var _i0=0,_this$battle$sides4=
this.battle.sides;_i0<_this$battle$sides4.length;_i0++){var side=_this$battle$sides4[_i0];for(var _i10=0,_side$active2=
...
if(!skipEmpty){for(var _i12=0,_this$$sprites2=
this.$sprites;_i12<_this$$sprites2.length;_i12++){var $spritesContainer=_this$$sprites2[_i12];
$spritesContainer.empty();
}
}for(var _i14=0,_this$battle$sides6=
this.battle.sides;_i14<_this$battle$sides6.length;_i14++){var _side$missedPokemon;var side=_this$battle$sides6[_i14];
...
}for(var _i16=0,_this$battle$pseudoWe2=

this.battle.pseudoWeather;_i16<_this$battle$pseudoWe2.length;_i16++){var pseudoWeather=_this$battle$pseudoWe2[_i16];
...
var isIntense=['desolateland','primordialsea','deltastream','hyperboreanarctic'].includes(this.curWeather);
...
var terrain='';for(var _i18=0,_this$battle$pseudoWe4=
this.battle.pseudoWeather;_i18<_this$battle$pseudoWe4.length;_i18++){var pseudoWeatherData=_this$battle$pseudoWe4[_i18];
...
var weatherhtml=this.weatherLeft();for(var _i20=0,_this$battle$sides8=
this.battle.sides;_i20<_this$battle$sides8.length;_i20++){var side=_this$battle$sides8[_i20];
...
break;
case'luckyroll':
var luckyRollArray=this.sideConditions[siden]['luckyroll'];
if(!luckyRollArray){
luckyRollArray=[];
this.sideConditions[siden]['luckyroll']=luckyRollArray;
}
var luckyRollLevels=this.battle.sides[siden].sideConditions['luckyroll'][1];
if(luckyRollArray.length<1&&luckyRollLevels>=1){
var die1=new Sprite(BattleEffects.dice,{
display:'block',
x:x-25,
y:y-40,
z:side.z,
...
var die2=new Sprite(BattleEffects.dice,{
display:'block',
x:x+30,
y:y-45,
z:side.z,
...
var die3=new Sprite(BattleEffects.dice,{
display:'block',
x:x+50,
y:y-40,
z:side.z,
...
break;
case'sleazyspores':
var sleazyspore1=new Sprite(BattleEffects.sleazyspores,{
display:'block',
x:side.leftof(40),
y:side.y-40,
z:side.z,
...
var sleazyspore2=new Sprite(BattleEffects.sleazyspores,{
display:'block',
x:side.leftof(20),
y:side.y-10,
z:side.z,
...
var sleazyspore3=new Sprite(BattleEffects.sleazyspores,{
display:'block',
x:side.leftof(-30),
y:side.y-30,
z:side.z,
...
var sleazyspore4=new Sprite(BattleEffects.sleazyspores,{
display:'block',
x:side.leftof(-10),
y:side.y-20,
z:side.z,
...
var pleasedontdothat=new Sprite(BattleEffects.stop,{
display:'block',
x:side.x+15,
y:side.y-35,
z:side.z,
...
break;
case'landmind':
var landmind=new Sprite(BattleEffects.landmind,{
display:'block',
x:side.x+15,
y:side.y-35,
z:side.z,
...
if(!this.animating)return;
if(this.sideConditions[siden][id]){for(var _i22=0,_this$sideConditions$2=
this.sideConditions[siden][id];_i22<_this$sideConditions$2.length;_i22++){var sprite=_this$sideConditions$2[_i22];sprite.destroy();}
...
preloadImage=function preloadImage(url){var _this5=this;
...
setRandomTrack=function setRandomTrack(tracks){var _tracks$bgmNum;
var bgmNum=this.numericId%tracks.length;
if(this.bgm&&this.bgmNum===bgmNum)return;

this.bgmNum=bgmNum;
this.specialTrack=null;

var track=(_tracks$bgmNum=tracks[bgmNum])!=null?_tracks$bgmNum:defaultTrack;
this.bgm=BattleSound.loadBgm(track.file,track.start,track.end,this.bgm);
this.updateBgm();
};_proto.
setSpecialBgm=function setSpecialBgm(specialBgm){
if(this.specialTrack===specialBgm)return;

this.bgmNum=-1;
this.specialTrack=specialBgm;

var track=specialTracks[specialBgm];
this.bgm=BattleSound.loadBgm(track.file,track.start,track.end,this.bgm);
this.updateBgm();
};_proto.
...
_this6.isFrontSprite=isFrontSprite;return _this6;
...
z:this.z,
opacity:0.5
},this.subsp),300);for(var _i24=0,_this$scene$battle$si2=
this.scene.battle.sides;_i24<_this$scene$battle$si2.length;_i24++){var side=_this$scene$battle$si2[_i24];for(var _i26=0,_side$active4=
...
afterMove=function afterMove(){var _this7=this;
if(!this.scene.animating)return false;
...
animFaint=function animFaint(pokemon){var _this8=this;
this.removeSub();
if(!this.scene.animating){
this.$el.remove();
if(this.$statbar){
...
animTransform=function animTransform(pokemon,isCustomAnim,isPermanent){var _this9=this;
...
if(_this9.cryurl&&doCry){
BattleSound.playEffect(_this9.cryurl);
}
...
if(this.effects[id]){for(var _i28=0,_this$effects$id2=
this.effects[id];_i28<_this$effects$id2.length;_i28++){var sprite=_this$effects$id2[_i28];sprite.destroy();}
...
kojimaCheck=function kojimaCheck(pokemon){
...
var types=pokemon.volatiles.typechange[1].split('/');for(var _i30=0;_i30<
types.length;_i30++){var type=types[_i30];
...
for(var _i31 in pokemon.turnstatuses){
if(_i31==='roost'&&!pokemon.getTypeList().includes('Flying'))continue;
status+=PokemonSprite.getEffectTag(_i31);
}
for(var _i32 in pokemon.movestatuses){
status+=PokemonSprite.getEffectTag(_i32);
}
...
bite:{
anim:function(scene,_ref0){var attacker=_ref0[0],defender=_ref0[1];
...
kick:{
anim:function(scene,_ref1){var attacker=_ref1[0],defender=_ref1[1];
scene.showEffect('foot',{
x:defender.x,
y:defender.y,
z:defender.z,
...
consume:{
anim:function(scene,_ref25){var defender=_ref25[0];
scene.showEffect('wisp',{
