	...
	this.LoginPasswordPopup = Popup.extend({
		...
		initialize: function (data) {
			...
			if (data.special === '@gmail') {
				buf += '<div id="g_id_onload" data-client_id="110658537122-38004878gi8lgh1vuvdvllh2402gsipd.apps.googleusercontent.com" data-context="signin" data-ux_mode="popup" data-callback="gapiCallback" data-auto_prompt="false"></div>';
