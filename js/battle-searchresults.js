...
!errorMessage&&preact.h("span",{"class":"col teambuildercol itemdesccol"},item.shortDesc)
));
};_proto.
...
!errorMessage&&preact.h("span",{"class":"col teambuildercol abilitydesccol"},ability.shortDesc)
));
};_proto.
...
preact.h("span",{"class":"col teambuildercol movedesccol"},move.shortDesc)
...
preact.h("span",{"class":"col teambuildercol movedesccol"},isSearchType?"(search type)":"(article)"),
...
preact.h("span",{"class":"col teambuildercol movedesccol"},"(egg group)"),
...
preact.h("span",{"class":"col teambuildercol movedesccol"},"(tier)"),
