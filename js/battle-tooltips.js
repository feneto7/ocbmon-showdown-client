...
text+="<p class=\"section\">";
var battlePokemon=clientPokemon||this.battle.findCorrespondingPokemon(pokemon);for(var _i0=0,_serverPokemon$moves2=
serverPokemon.moves;_i0<_serverPokemon$moves2.length;_i0++){var moveid=_serverPokemon$moves2[_i0];
var move=this.battle.dex.moves.get(moveid);
var moveName="&#8226; "+move.name;
if(battlePokemon!=null&&battlePokemon.moveTrack){for(var _i10=0,_battlePokemon$moveTr2=
battlePokemon.moveTrack;_i10<_battlePokemon$moveTr2.length;_i10++){var row=_battlePokemon$moveTr2[_i10];
if(moveName===row[0]){
...
text+="<p class=\"section\">";for(var _i12=0,_clientPokemon$moveTr2=
...
var atLeastOne=false;for(var _i14=0,_this$battle$sides4=
this.battle.sides;_i14<_this$battle$sides4.length;_i14++){var side=_this$battle$sides4[_i14];
...
if(side.battle.speciesClause)return false;for(var _i16=0,_side$pokemon4=
side.pokemon;_i16<_side$pokemon4.length;_i16++){var ally=_side$pokemon4[_i16];
...
var pokemon=clientPokemon||serverPokemon;
var isPowerTrick=clientPokemon==null?void 0:clientPokemon.volatiles['powertrick'];for(var _i18=0,_Dex$statNamesExceptH2=
Dex.statNamesExceptHP;_i18<_Dex$statNamesExceptH2.length;_i18++){var statName=_Dex$statNamesExceptH2[_i18];
...
if(this.battle.gen<=1){for(var _i20=0,_Dex$statNamesExceptH4=
Dex.statNamesExceptHP;_i20<_Dex$statNamesExceptH4.length;_i20++){var _statName=_Dex$statNamesExceptH4[_i20];
...
if(ability==='hustle'||ability==='gorillatactics'&&!(clientPokemon!=null&&clientPokemon.volatiles['dynamax'])||ability==='boardpowerv'){
stats.atk=Math.floor(stats.atk*1.5);
}
if(weather){
...
if(allyActive){for(var _i22=0;_i22<
allyActive.length;_i22++){var ally=allyActive[_i22];
...
speedModifiers.push(2);
}for(var _i24=0,_Dex$statNamesExceptH6=
Dex.statNamesExceptHP;_i24<_Dex$statNamesExceptH6.length;_i24++){var _statName2=_Dex$statNamesExceptH6[_i24];
...
var abilityName=ability==='plus'?'Plus':'Minus';for(var _i26=0;_i26<
_allyActive.length;_i26++){var _ally=_allyActive[_i26];
...
var chainedSpeedModifier=1;for(var _i28=0;_i28<
speedModifiers.length;_i28++){var modifier=speedModifiers[_i28];
...
if(clientPokemon!=null&&clientPokemon.volatiles['agile']){
stats.spe=Math.floor(stats.spe*1.25);
}else if(clientPokemon!=null&&clientPokemon.volatiles['strong']){
stats.spe=Math.floor(stats.spe*0.75);
}

if(clientPokemon!=null&&clientPokemon.volatiles['colorboost']){
stats.atk=Math.floor(stats.atk*1.25);
}



if(item==='choicecloak'&&!(clientPokemon!=null&&clientPokemon.volatiles['dynamax'])){
stats.spd=Math.floor(stats.spd*1.5);
}
if(item==='choicejacket'&&!(clientPokemon!=null&&clientPokemon.volatiles['dynamax'])){
stats.def=Math.floor(stats.def*1.5);
}
...
if(!short){
var hasModifiedStat=false;for(var _i30=0,_Dex$statNamesExceptH8=
Dex.statNamesExceptHP;_i30<_Dex$statNamesExceptH8.length;_i30++){var statName=_Dex$statNamesExceptH8[_i30];
...
buf+='<p>';
}for(var _i32=0,_Dex$statNamesExceptH0=

Dex.statNamesExceptHP;_i32<_Dex$statNamesExceptH0.length;_i32++){var _statName3=_Dex$statNamesExceptH0[_i32];
...
ppUsed=function ppUsed(move,pokemon){for(var _i34=0,_pokemon$moveTrack2=
pokemon.moveTrack;_i34<_pokemon$moveTrack2.length;_i34++){var _ref2=_pokemon$moveTrack2[_i34];var moveName=_ref2[0];var _ppUsed=_ref2[1];
...
value.abilityModify(1.3,"Illuminate");for(var _i36=0,_pokemon$side$active2=
...
if(pokemon!=null&&pokemon.volatiles['agile']){
value.abilityModify(0.75,'Ancient Style');
}else if(pokemon!=null&&pokemon.volatiles['strong']){
...
return text;
};return BattleTooltips;}();BattleTooltips.LONG_TAP_DELAY=350;BattleTooltips.longTapTimeout=0;BattleTooltips.elem=null;BattleTooltips.parentElem=null;BattleTooltips.isLocked=false;BattleTooltips.isPressed=false;BattleTooltips.zMoveEffects={'clearnegativeboost':"Restores negative stat stages to 0",'crit2':"Crit ratio +2",'heal':"Restores HP 100%",'curse':"Restores HP 100% if user is Ghost type, otherwise Attack +1",'redirect':"Redirects opposing attacks to user",'healreplacement':"Restores replacement's HP 100%"};BattleTooltips.zMoveTable={Poison:"Acid Downpour",Fighting:"All-Out Pummeling",Dark:"Black Hole Eclipse",Grass:"Bloom Doom",Normal:"Breakneck Blitz",Rock:"Continental Crush",Steel:"Corkscrew Crash",Dragon:"Devastating Drake",Electric:"Gigavolt Havoc",Water:"Hydro Vortex",Fire:"Inferno Overdrive",Ghost:"Never-Ending Nightmare",Bug:"Savage Spin-Out",Psychic:"Shattered Psyche",Ice:"Subzero Slammer",Flying:"Supersonic Skystrike",Ground:"Tectonic Rage",Fairy:"Twinkle Tackle","???":"",Blood:"",Bone:"",Chaos:"",Cosmic:"",Crystal:"",Cyber:"",Divine:"",Fabric:"",Fear:"",Food:"",Glass:"",Greasy:"",Heart:"",Light:"",Magic:"",Magma:"",Meme:"",Nuclear:"",Ogre:"",Paint:"",Paper:"",Plastic:"",Qmarks:"",Rubber:"",Shadow:"",Sound:"",Steam:"",Tech:"",Time:"",Virus:"",Void:"",Wack:"",Wind:"",Wood:"",Zombie:"",Vanilla:"",Cherry:"",Strawberry:"",Apple:"",Orange:"",Banana:"",Lemon:"",Lime:"",Blueberry:"",Grape:"",Raspberry:"",Chocolate:""};BattleTooltips.maxMoveTable={Poison:"Max Ooze",Fighting:"Max Knuckle",Dark:"Max Darkness",Grass:"Max Overgrowth",Normal:"Max Strike",Rock:"Max Rockfall",Steel:"Max Steelspike",Dragon:"Max Wyrmwind",Electric:"Max Lightning",Water:"Max Geyser",Fire:"Max Flare",Ghost:"Max Phantasm",Bug:"Max Flutterby",Psychic:"Max Mindstorm",Ice:"Max Hailstorm",Flying:"Max Airstream",Ground:"Max Quake",Fairy:"Max Starfall","???":"Max Memeitude",Blood:"",Bone:"",Chaos:"",Cosmic:"",Crystal:"",Cyber:"",Divine:"",Fabric:"",Fear:"",Food:"",Glass:"",Greasy:"",Heart:"",Light:"",Magic:"",Magma:"",Meme:"",Nuclear:"",Ogre:"",Paint:"",Paper:"",Plastic:"",Qmarks:"",Rubber:"",Shadow:"",Sound:"",Steam:"",Tech:"",Time:"",Virus:"",Void:"",Wack:"",Wind:"",Wood:"",Zombie:"",Vanilla:"",Cherry:"",Strawberry:"",Apple:"",Orange:"",Banana:"",Lemon:"",Lime:"",Blueberry:"",Grape:"",Raspberry:"",Chocolate:""};BattleTooltips.incenseTypes={'Odd Incense':'Psychic','Rock Incense':'Rock','Rose Incense':'Grass','Sea Incense':'Water','Wave Incense':'Water'};BattleTooltips.itemTypes={'Black Belt':'Fighting','Black Glasses':'Dark','Charcoal':'Fire','Dragon Fang':'Dragon','Hard Stone':'Rock','Magnet':'Electric','Metal Coat':'Steel','Miracle Seed':'Grass','Mystic Water':'Water','Never-Melt Ice':'Ice','Poison Barb':'Poison','Sharp Beak':'Flying','Silk Scarf':'Normal','Silver Powder':'Bug','Soft Sand':'Ground','Spell Tag':'Ghost','Twisted Spoon':'Psychic','Katana':'Steel','Cute Bow':'Fairy'};BattleTooltips.orbUsers={'Latias':['Soul Dew'],'Latios':['Soul Dew'],'Dialga':['Adamant Crystal','Adamant Orb'],'Palkia':['Lustrous Globe','Lustrous Orb'],'Giratina':['Griseous Core','Griseous Orb'],'Venomicon':['Vile Vial']};BattleTooltips.orbTypes={'Soul Dew':['Psychic','Dragon'],'Adamant Crystal':['Steel','Dragon'],'Adamant Orb':['Steel','Dragon'],'Lustrous Globe':['Water','Dragon'],'Lustrous Orb':['Water','Dragon'],'Griseous Core':['Ghost','Dragon'],'Griseous Orb':['Ghost','Dragon'],'Vile Vial':['Poison','Flying']};BattleTooltips.noGemMoves=['Fire Pledge','Fling','Grass Pledge','Struggle','Water Pledge'];var
...
var gen=+formatid.slice(3,4);
if(Number.isNaN(gen)){
gen=8;
}
var modMatch=this.formatid.match(/^gen(\d+)([a-z]+)(only|nationaldex)/);
if(modMatch){
var genNumber=modMatch[1],modName=modMatch[2],modified=modMatch[3];
if(!Number.isNaN(parseInt(genNumber,10))){
gen=parseInt(genNumber,10);
}
this.dex=Dex.mod(gen,""+modName+(modified==='only'?'only':'natdex'));
}else{
